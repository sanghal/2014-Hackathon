 ...
 * by Mark Caudill and James Hartig on behalf of Grooveshark.
 *
 * Based on Backbone.js 1.0.0
...
;(function(root) {
  ...
  // The top-level namespace. All public Bedrock classes and modules will
  ...
  // the `$` variable.
  Bedrock.$ = root.jQuery || root.Zepto || root.ender || root.$;
  ...
  var Events = Bedrock.Events = {
    ...
    trigger: function(name) {
      ...
      switch (args.length) {
        case 1: args = []; break;
        case 2: args = [args[1]]; break;
        case 3: args = [args[1], args[2]]; break;
        default: args = slice.call(args, 1);
      }
      if (!eventsApi(this, 'trigger', name, args)) return this;
      var events = this._events[name];
      if (events) triggerEvents(events, args);
      if (events = this._events.all) triggerEvents(events, arguments);
      return this;
    },
  ...
  _.each(listenMethods, function(implementation, method) {
    Events[method] = function(obj, name, callback) {
      ...
      var id = obj._listenerId || (obj._listenerId = uniqueLIDCount++);
      listeners[id] = obj;
      if (typeof name === 'object') callback = this;
  ...
  _.extend(Model.prototype, Events, {
    ...
    set: function(key, val, opts) {
      var attr, attrs, unset, changes, silent, changing, prev, prev, current,
      ...
      if (!silent && changes.length) {
        ...
        // It addrresses changes being recursively nested within `"change"` events.
  ...
  _.extend(Collection.prototype, Events, {
    ...
    set: function(models, opts) {
      ...
      var i, l, model, existing, sort, id;
      var at = options.at;
      ...
      if (options.remove) {
        for (i = 0, l = this.length; i < l; ++i) {
          model = this.models[i];
          if (model != null && !modelMap[model.cid]) toRemove.push(model);
        }
      ...
      if (numToAdd) {
        ...
        if (at != null && at < this.length) {
          ...
          // Push.apply could hit args limit. Loop is faster anyways.
  ...
  _.extend(History.prototype, Events, {
    ...
    start: function(options) {
      ...
      if (oldIE && this._wantsHashChange) {
        this.iframe = Bedrock.$('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo('body')[0].contentWindow;
